...
//{
//    static const char *topic   = "lwip_topic/Emiddssss";
//    static const char *message = "Prueba MQTT Emilio";
//
//    LWIP_UNUSED_ARG(ctx);
//
//    PRINTF("Going to publish to the topic \"%s\"...\r\n", topic);
...
// Opcional: imprimir contenido recibido en consola
/*
for (int i = 0; i < len; i++)
{
    if (isprint(data[i]))
...
//static void publish_message(void *ctx, const char topic, const char message)
//{
////    static const char *topic_temp   = TOPIC_PUB_TEMP_STATE;
////    static const char *message_temp = "Ventilador encendido";
////    static const char *topic_lght   = TOPIC_PUB_LIGHT_STATE;
////    static const char *message_lght = "Led encendido";
//
//    LWIP_UNUSED_ARG(ctx);
//
//
...
//    {
//        int temperatura = atoi(payload);
//        BOOL activated = temp_motor_app(temperatura);
//
//        if (activated)
//        {
//            const char *msg = "Ventilador encendido";
//            //mqtt_publish(mqtt_client, TOPIC_PUB_TEMP_STATE, msg, strlen(msg), 1, 0, mqtt_message_published_cb, (void *)TOPIC_PUB_TEMP_STATE);
//            publish_message(NULL, TOPIC_PUB_TEMP_STATE, msg);
//        }
//    }
//    else if (strcmp(topic_incoming, TOPIC_SUB_LIGHT) == 0)
//    {
//        int luz = atoi(payload);
//        BOOL activated = light_led_app(luz);
//
//        if (activated)
//        {
//            const char *msg = "LED encendido";
//            //mqtt_publish(mqtt_client, TOPIC_PUB_LIGHT_STATE, msg, strlen(msg), 1, 0, mqtt_message_published_cb, (void *)TOPIC_PUB_LIGHT_STATE);
//            publish_message(NULL, TOPIC_PUB_LIGHT_STATE, msg);
//        }
//    }
//
...
//        if(!temp_flag)
//        {
//            SCTIMER_UpdatePwmDutycycle(SCT0, 0U, 50U, event);
//            temp_flag = TRUE;
//            return TRUE;
//        }
//    }
//    else
//    {
//        SCTIMER_UpdatePwmDutycycle(SCT0, 0U, 0U, event);
//        temp_flag = FALSE;
//    }
//
//    return FALSE;
...
//int light_led_app(int light)
//{
//    if(light > LIGHT_TRHESHOLD)
//    {
//        if(!light_flag)
//        {
//            SCTIMER_UpdatePwmDutycycle(SCT0, 1U, 100U, event);
//            light_flag = TRUE;
//            return TRUE;
//        }
//    }
//    else
//    {
//        SCTIMER_UpdatePwmDutycycle(SCT0, 1U, 0U, event);
//        light_flag = FALSE;
//    }
//
//    return FALSE;
